...
namespace VisTuApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(maximumLength: 20, MinimumLength = 3, ErrorMessage = "Não pode possuir menos de 3 ou mais que 20 caracteres")]
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "O {0} precisa ter ao menos {2} e no máximo {1} characters.", MinimumLength = 6)]
